...
public class NewsTitleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView newsTitleRecyclerView= (RecyclerView) view.findViewById(R.id.news_recycler_view);
    ...
    private List<News> getNews() {
        ...
        for (int i = 0; i <=50; i++) {
            ...
            news.setContent(getRnadomLengthContent("This is news content"+i+"."));
            newsList.add(news);
        }
        return newsList;
    }

    private String getRnadomLengthContent(String content) {
